...
async function offerAndRunOverTests(): Promise<void> {
  ...
  const rig = await makeRig();
  rig.sock.deliver(rig.snap({ full: true }));
  rig.sock.deliver({ t: "offer", id: 1, choices: ["it_a", "it_b"], k: "blessing", tr: "none", cb: false });
  rig.sock.deliver({ t: "offer", id: 1, choices: ["it_a", "it_b"], k: "blessing", tr: "none", cb: false }); // resend
  ...
  rig.sock.deliver({ t: "offer", id: 2, choices: ["it_c"], k: "blessing", tr: "none", cb: false });
