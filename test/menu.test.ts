...
async function main(): Promise<void> {
  ...
  section("solo requires explicit KIT, explicit PET, then one final combined confirmation");
  {
    ...
    check("PET options are registry-derived: No Pet plus eight companions and one hidden reserve",
  ...
  section("Amber Camp Kennel: pet thumbnails + price digits + CTA geometry");
  {
    ...
    check("kennel lists all eight companions",
      kennel !== undefined
      && ["Doggie", "Wick", "Cat", "Pebble", "Baby Dragon", "Clatter", "Baby Slime", "Nullfin"].every((name) =>
