...
function worldBindingWireTests(): void {
  ...
  check("protocol version covers the PALE THRONE F75 giant (v29: pale + pale_seam kinds + pale_debris prop; no new EnemyWire field)", PROTOCOL_VERSION === 29, `v=${PROTOCOL_VERSION}`);
