...
function worldBindingWireTests(): void {
  ...
  check("protocol version covers room-correctness (v4) + content (v5) + co-op (v6) + the depth world (v7) + shop AND bestiary (v8) + the remote-dash sync (v9) + the weapon effect wave (v10) + the hotbar cap swap (v11) + the rarity/mystery wave (v12) + earned-windows boss kinds (v13)", PROTOCOL_VERSION === 13, `v=${PROTOCOL_VERSION}`);
