...
function worldBindingWireTests(): void {
  ...
  check("protocol version covers room-correctness (v4) + content (v5) + co-op (v6) + the depth world (v7) + Patch's shop AND the bestiary wave (v8) + earned-windows boss kinds (v9)", PROTOCOL_VERSION === 9, `v=${PROTOCOL_VERSION}`);
