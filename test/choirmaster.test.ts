...
import {
  bossKindForFloor, CHOIRMASTER_FLOOR, SEVER_FLOOR, GORGE_FLOOR, PALE_FLOOR, isBossKind,
...
function pinGates(): void {
  ...
  check("PROTOCOL_VERSION is 41 (Undertow F65 river_comes_back after PVP v40)", PROTOCOL_VERSION === 41);
