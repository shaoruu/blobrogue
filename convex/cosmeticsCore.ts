...
export const COSMETICS: readonly CosmeticDef[] = [
  ...
  { id: "hat_bone_band", slot: "hat", name: "Bone Band", unlock: "earned", need: { deepestFloor: 9 }, hint: "reach floor 9", assetKey: "hat_bone_band" },
  { id: "hat_brass", slot: "hat", name: "Brass Plate-Cap", unlock: "earned", need: { deepestFloor: 11 }, hint: "reach floor 11", assetKey: "hat_brass" },
  { id: "hat_ember_visor", slot: "hat", name: "Ember Visor", unlock: "earned", need: { deepestFloor: 16 }, hint: "reach floor 16", assetKey: "hat_ember_visor" },
  { id: "hat_pale_hood", slot: "hat", name: "Pale Hood", unlock: "earned", need: { deepestFloor: 22 }, hint: "reach floor 22", assetKey: "hat_pale_hood" },
  ...
  { id: "face_pale_bandage", slot: "face", name: "Pale Bandage", unlock: "earned", need: { totalKills: 200 }, hint: "200 all-time kills", assetKey: "face_pale_bandage" },
  { id: "face_choir_veil", slot: "face", name: "Choir Veil", unlock: "earned", need: { deepestFloor: 30 }, hint: "reach floor 30", assetKey: "face_choir_veil" },
