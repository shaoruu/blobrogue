...
export interface GsTicketPayload {
  ...
  pt?: string;  // equipped companion pet (minted only from a validated account profile)
}
...
// order pid, exp, wld, nm, cl, pt — the byte contract with server/src/auth.ts mintTicket.
