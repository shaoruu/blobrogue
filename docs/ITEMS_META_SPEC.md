...
UNCOMMON(w30): Side Channel: dash or hard aim flick arms one plain shot along the previous aim, scaling to 55% damage or 30% against bosses | Hollow Points pierce+1 | Ricochet bounce+1 |
