...
UNCOMMON(w30): Side Channel: dash or hard aim flick arms one plain shot along the previous aim; Lv1–3 scale damage 55/65/75%, boss damage 30/34/38%, armed window 2.0/2.3/2.6s, and cooldown 1.20/1.05/0.90s | Hollow Points pierce+1 | Ricochet bounce+1 |
