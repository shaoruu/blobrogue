...
🟢→🟡 Legendary gun TEXTURES — SAME as umbra fix: all 5 legendaries (umbra/reaper/hive/midas/lodestone) generated to AD briefs, oriented cosmetics done too. Gating → wire. [gating]
