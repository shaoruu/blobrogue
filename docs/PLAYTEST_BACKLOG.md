...
🔵(building bc-6ddd4e7b) Drag precision + drag-to-discard (UI spec) — in the fix build.
...
🔵(building bc-6ddd4e7b) Double-tap dash + rebindable dash key (R).
