...
**3. It's a place, not a menu.** (Per the open-world call.) You have a home — Amber Camp — that grows as you play, and you descend through a *connected* world (Amberwild → Rootbound Warrens → Sunless Caves → The Deep → Gilded Archive → Emberreach), not numbered flashcards. The blob has somewhere to come home to. That's what makes losing sting and returning feel good, and it's the emotional anchor when multiplayer lands: **your friends come to your town, then you go get in trouble together.**
...
**2. THE MIRROR BLOB — a boss that IS you.** A hostile blob of black amber that has learned the *same schools you have,* and uses the RESONANCE against you. It fires *your* weapon types, casts a *corrupted* Resonance, and telegraphs like you do. The thematic climax: the innocent blob's dark reflection. (Buildable: it's a reskinned player entity running enemy AI + the telegraph system + a scripted Resonance. Genuinely eerie and it *means* something — the "power has a cost" theme, embodied.) Jet remains later endgame content after the approved first-clear chain; it is not a replacement for an implemented boss.

**3. "THE HOLLOW CHOIR" — the approved Emberreach world-boss.** A colossal being made of hundreds of dead blobs fused together, half-sunk in the lava biome, that *sings* (the Choir school, weaponized against you): telegraphed lightning-strike rain, a charge-and-discharge floor mechanic, and a few song-linked voice fragments whose defeat silences specific pressure lanes. Multi-phase, screen-filling, the co-op raid moment when multiplayer lands. Warm-dark whimsy at max volume: it's tragic *and* terrifying.
