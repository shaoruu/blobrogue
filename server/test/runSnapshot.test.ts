...
try {
  ...
  ianBody.ownedItemIds.push("big_iron", "big_iron");
  ianBody.mods.damageMult = 1.7;
  ansonBody.hp = 3.5;
  ansonBody.coins = 91;
  ansonBody.ownedWeapons.push("shotgun");
  ansonBody.ownedItemIds.push("swift_boots");
  ...
  check("Ian's HP, kit, weapons, blessings, mods, and coins survive",
    ...
    && restoredIan.ownedItemIds.filter((item) => item === "big_iron").length === 2
  ...
  check("Anson's HP, kit, weapons, blessings, mods, and coins survive",
    ...
    && restoredAnson.ownedItemIds.includes("swift_boots")
