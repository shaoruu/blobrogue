...
const SUBJECTS = {
  ...
  rootward: "a squat walking treestump monster whose whole front is a broad woven-root shield wall, mossy green and bark brown, small stubborn amber eyes peering around the edge, gnarled root-tendril fingers raised as if pulling roots up from the earth",
  echojack: "a lanky mischievous jester-imp monster of pale violet mist hung with tarnished silver bells, a wide knowing grin, mid-sidestep",
  seamcutter: "a low blade-bodied plow monster shaped like a living keel fin cutting along the ground, rose-pink chitin over dark silt, a raised ridge of earth piling off one flank",
  caskbellows: "a squat brass-and-oak barrel creature with a cannon bore for a mouth and a large wind-up crank handle on its back, riveted plates, small intent eyes",
  sinderling: "a small scampering ember imp monster of charcoal and glowing orange cracks, a coal-fire glow in its open mouth, trailing sparks",
  mason: "a stocky soot-stained bricklayer imp monster of dark clinker stone and glowing mortar seams, a hod of embers-bricks on its back, broad trowel hands, intent orange eyes",
  fragment: "a small broken shard of a ghostly choir face, translucent pale-blue, one hollow singing mouth, trailing torn wisps",
  echo: "a faint hollow translucent pale-violet silhouette of a small monster, semi-transparent, ringing with faint sound lines, clearly a mirage",
  knell: "a small cracked bronze handbell creature planted on the ground, faint red fuse-glow in the crack, vibrating with sound rings",
  marshal: "a large treestump-golem commander monster with a massive woven-root tower shield front and a mossy banner stump on its back, bark armor, stern amber eyes",
  toll: "a huge ancient cracked bronze bell monster with a baleful face embossed on its body, hanging inside a blackened wooden frame, deep verdigris and gold",
