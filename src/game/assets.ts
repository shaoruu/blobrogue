...
export const SHEETS: Partial<Record<string, SheetDef>> = {
  ...
  // Pack #2 companions (emberfox/owlet/mothling/rolly): the full walk + idle + attack contract,
  ...
  "emberfox.walk": { src: "/sprites/pets/emberfox_walk.png", fps: 9 },
  "emberfox.idle": { src: "/sprites/pets/emberfox_idle.png", fps: 5 },
  "emberfox.attack": { src: "/sprites/pets/emberfox_attack.png", fps: 12 },
  "owlet.walk": { src: "/sprites/pets/owlet_walk.png", fps: 9 },
  "owlet.idle": { src: "/sprites/pets/owlet_idle.png", fps: 5 },
  "owlet.attack": { src: "/sprites/pets/owlet_attack.png", fps: 12 },
  "mothling.walk": { src: "/sprites/pets/mothling_walk.png", fps: 9 },
  "mothling.idle": { src: "/sprites/pets/mothling_idle.png", fps: 5 },
  "mothling.attack": { src: "/sprites/pets/mothling_attack.png", fps: 12 },
  "rolly.walk": { src: "/sprites/pets/rolly_walk.png", fps: 9 },
  "rolly.idle": { src: "/sprites/pets/rolly_idle.png", fps: 5 },
  "rolly.attack": { src: "/sprites/pets/rolly_attack.png", fps: 12 },
...
const SOURCES: Record<SpriteName, string> = {
  ...
  // The cat + baby dragon + baby slime companion idle sprites (same 64x64 format as the
  // doggie). The slime uses the "slime_pet" key so it never collides with the "slime" enemy.
  ...
  emberfox: "/sprites/pets/emberfox.png",
  owlet: "/sprites/pets/owlet.png",
  mothling: "/sprites/pets/mothling.png",
  rolly: "/sprites/pets/rolly.png",
...
const HELD_SOURCES: Partial<Record<WeaponId, string>> = {
  ...
  resonant_fork: "/sprites/held_resonant_fork.png",
...
const PICKUP_SOURCES: Partial<Record<WeaponId, string>> = {
  ...
  resonant_fork: "/sprites/weapon_resonant_fork.png",
