...
export const WAVE_SOUNDS = {
  ...
  // Wave C guns audio (wave-c-guns-v1): authored takes replace silent takes:[].
  "shootHushiron": {
    stem: "sfx/hushiron_fire", variants: 3, gain: 0.62, bus: "sfx",
    priority: WAVE_PRIORITY.weapon, jitter: 0.05, spatial: true,
    duck: [dM(0.85, 0.05, 0.2)],
    fallback: { sample: "cannon", rate: 1.05, lowpassHz: 1400 },
  },
  "shootBacktalk": {
    stem: "sfx/backtalk_fire", variants: 2, gain: 0.6, bus: "sfx",
    priority: WAVE_PRIORITY.weapon, jitter: 0.05, spatial: true,
    duck: [dM(0.85, 0.05, 0.2)],
    fallback: { sample: "burst", rate: 1.15 },
  },
  "shootLamplighter": {
    stem: "sfx/lamplighter_fire", variants: 2, gain: 0.58, bus: "sfx",
    priority: WAVE_PRIORITY.weapon, jitter: 0.05, spatial: true,
    duck: [dM(0.85, 0.05, 0.2)],
    fallback: { sample: "homing", rate: 1.1 },
  },
  "shootFaultlink": {
    stem: "sfx/faultlink_fire", variants: 2, gain: 0.66, bus: "sfx",
    priority: WAVE_PRIORITY.weapon, jitter: 0.05, spatial: true,
    duck: [dM(0.85, 0.05, 0.2)],
    fallback: { sample: "tesla", rate: 1.05, highpassHz: 400 },
  },
  "backtalk.parry": {
    stem: "sfx/backtalk_parry", variants: 2, gain: 0.72, bus: "sfx",
    priority: WAVE_PRIORITY.impact, jitter: 0.04, spatial: true,
    duck: [dM(0.7, 0.08, 0.25)],
    fallback: { sample: "parry", rate: 1.05 },
  },
  "backtalk.return": {
    stem: "sfx/backtalk_return", variants: 3, gain: 0.7, bus: "sfx",
    priority: WAVE_PRIORITY.weapon, jitter: 0.05, spatial: true,
    duck: [dM(0.75, 0.08, 0.3)],
    fallback: { sample: "cannon", rate: 1.1, lowpassHz: 1600 },
  },
  "lamplighter.patch": {
    stem: "sfx/lamplighter_patch", variants: 2, gain: 0.5, bus: "sfx",
    priority: WAVE_PRIORITY.impact, jitter: 0.04, spatial: true,
    fallback: { sample: "blessing", rate: 1.15 },
  },
  "faultlink.link": {
    stem: "sfx/faultlink_link_v1", variants: 1, gain: 0.55, bus: "sfx",
    priority: WAVE_PRIORITY.impact, jitter: 0.04, spatial: true,
    duck: [dM(0.8, 0.06, 0.25)],
    fallback: { sample: "tesla", rate: 0.9, highpassHz: 600 },
  },
  "red_pen.snap": {
