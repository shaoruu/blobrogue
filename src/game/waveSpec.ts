...
export const WAVE_SOUNDS = {
  ...
  // ---- §2 THE WAKE F80 — THE LAST PROCESSION (wake-procession-v1) --------------------
  // Escort identity: dusk funeral convoy / last-light warmth corridor / closing dark front.
  // BierPulse is a sparse one-shot, never a loop bed. NIGHTFALL_PROCESSION retired forever.
  ...
  "wake.processionFront": {
    stem: "boss/wake_procession_front", variants: 3, gain: 0.90, bus: "sfx", priority: WAVE_PRIORITY.bossTell,
  ...
  "wake.processionFail": {
    stem: "boss/wake_procession_fail", variants: 2, gain: 0.84, bus: "sfx", priority: WAVE_PRIORITY.bossTell,
  ...
  "wake.processionBlockerHighlight": {
    stem: "boss/wake_procession_blocker_highlight", variants: 2, gain: 0.70, bus: "voiceTell", priority: WAVE_PRIORITY.bossTell,
    jitter: 0.03, spatial: true, isOffCameraUncapped: true, cooldownMs: 200, isPerEntityCooldown: true,
    duck: [dM(0.7, 0.1, 0.3)],
  },
  "wake.processionBlockerBreak": {
    stem: "boss/wake_procession_blocker_break", variants: 2, gain: 0.78, bus: "sfx", priority: WAVE_PRIORITY.bossTell,
    jitter: 0.03, spatial: true,
...
export const WAVE_TELLS: Readonly<Record<string, Readonly<Record<string, MoveTells>>>> = {
  ...
  // THE WAKE F80 — THE LAST PROCESSION (escort blackout → dark front → light punish).
  wake: {
    rush: { windup: "wake.processionTell", lock: "wake.processionLock", active: "wake.processionFront", impact: "wake.processionFail", recover: "wake.processionRecover" },
    sweep: { windup: "wake.processionShadowWarn", active: "wake.processionFront" },
  },
  skeleton: {
