...
export const COSMETIC_ASSET_SOURCES: Record<string, CosmeticAssetDef> = {
  ...
  // hats, pack #2 (Wren-locked; assetKey == file stem == catalog id). Sizes/offsets are start
  // points the AD can tune per line; a tall/perched piece rides higher (-y), a low band sits
  // lower (+y).
  hat_cork: { socket: "head", sizePx: 46, offsetY: -3, src: orientedSources("hat_cork") },
  hat_lamp_brim: { socket: "head", sizePx: 50, offsetY: -3, src: orientedSources("hat_lamp_brim") },
  hat_root: { socket: "head", sizePx: 48, offsetY: 2, src: orientedSources("hat_root") },
  hat_ember_visor: { socket: "head", sizePx: 46, offsetY: 1, src: orientedSources("hat_ember_visor") },
  hat_bone_band: { socket: "head", sizePx: 46, offsetY: 3, src: orientedSources("hat_bone_band") },
  hat_brass: { socket: "head", sizePx: 48, offsetY: -2, src: orientedSources("hat_brass") },
  hat_pale_hood: { socket: "head", sizePx: 50, offsetY: -2, src: orientedSources("hat_pale_hood") },
  hat_null_crown: { socket: "head", sizePx: 48, offsetY: 2, src: orientedSources("hat_null_crown") },
  // faces
  ...
  // faces, pack #2 (Wren-locked; assetKey == file stem == catalog id).
  face_amber_specs: { socket: "face", sizePx: 40, offsetX: -3, offsetY: -4, src: orientedSources("face_amber_specs") },
  face_coal_smudge: { socket: "face", sizePx: 40, offsetX: -3, offsetY: -2, src: orientedSources("face_coal_smudge") },
  face_shale_goggles: { socket: "face", sizePx: 40, offsetX: -3, offsetY: -5, src: orientedSources("face_shale_goggles") },
  face_pale_bandage: { socket: "face", sizePx: 36, offsetX: -3, offsetY: -2, src: orientedSources("face_pale_bandage") },
  face_resin_monocle: { socket: "face", sizePx: 24, offsetX: -14, offsetY: -4, src: orientedSources("face_resin_monocle") },
  face_choir_veil: { socket: "face", sizePx: 42, offsetX: -3, offsetY: -3, src: orientedSources("face_choir_veil") },
};
