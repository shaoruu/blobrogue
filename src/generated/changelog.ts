...
export const CHANGELOG: ChangelogSection[] = [
  {
    ...
    date: "unreleased",
    entries: [
      { title: "Kits now work in SOLO", body: "playing solo (and classic co-op) finally spawns you as your chosen class — you get its stat lean, starting weapon, passives, and a live ult meter with the right badge and signature row — instead of the kitless neutral blob with a pistol. Your Amber Camp pick now applies everywhere, not just online." },
