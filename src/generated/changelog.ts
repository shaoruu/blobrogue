...
export const CHANGELOG: ChangelogSection[] = [
  {
    ...
    date: "unreleased",
    entries: [
      { title: "F70 CLAIMANT sounds like ALL THINGS OWED now", body: "the Claimant fight left the Choir/Weaver placeholder bank. Entrance, phase, death, the 1.4s crown-lane tell + aim-lock + descent, kneel punish/recover, capped miss, claim-token pickup/pass/drop, socket light/deposit, guard chips, and the overcommit bait each play their own gilded-debt one-shots (batch `claimant-owed-v1`). CROWNFALL stays retired." },
