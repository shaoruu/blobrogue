...
export const CHANGELOG: ChangelogSection[] = [
  {
    ...
    date: "unreleased",
    entries: [
      { title: "F80 THE WAKE has its own funeral-escort sound now", body: "THE LAST PROCESSION no longer borrows the Hollow Choir bank. Entrance / phase / death, the 1.5s blackout tell + dusk lock, the moving dark front, punish/recover/fail, bier pulse (sparse one-shot, never a bed) + bier advance, blocker highlight/break, threshold, shelter, and shadow-front warn all ship as dedicated `wake.procession*` stems. NIGHTFALL PROCESSION stays retired." },
