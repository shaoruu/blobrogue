...
export const CHANGELOG: ChangelogSection[] = [
  {
    ...
    date: "unreleased",
    entries: [
      { title: "F80 Wake audio — THE LAST PROCESSION", body: "swapped the Choir/Weaver placeholder bank for authored `wake.procession*` stems (entrance/phase/death, 1.5s blackout tell + dusk lock + dark-front advance, light-bound punish/recover/fail, sparse bier pulse/advance, blocker highlight/break, threshold, shelter, shadow warn). Batch `wake-procession-v1`. BierPulse is a sparse one-shot, never a loop bed. NIGHTFALL PROCESSION stays retired." },
