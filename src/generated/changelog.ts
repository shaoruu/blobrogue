...
export const CHANGELOG: ChangelogSection[] = [
  {
    ...
    entries: [
      ...
      { title: "PVP beyond the private arena", body: "public matchmaking is still switched off, and a Wave 3 siege / objective mode is still ahead — the private room-code arena's kit ultimates, ring-weather, and mid-match drafts have already shipped." },
