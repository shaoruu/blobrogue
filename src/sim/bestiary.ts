...
export const WAVE_B_SYNTHESIS: Readonly<Partial<Record<EnemyKind, readonly EnemyKind[]>>> = {
  ...
  warm_pulse: ["caskbellows"],         // carry/deposit Warm Pulse (steal verb)
  relief_vent: ["caskbellows"],        // highlighted deposit / relief vent
...
export const ENEMY_MOVESET: Readonly<Record<EnemyKind, readonly AttackMove[]>> = {
  ...
  choir_pillar: [],
  // UNDERTOW (F65): reverse escape + THE RIVER COMES BACK signature.
  undertow: ["river_comes_back", "roar"],
  warm_pulse: [],
  relief_vent: [],
  flood_front: [],
  // CLAIMANT (F70): coordination arena + ALL THINGS OWED signature.
