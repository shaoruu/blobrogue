...
// Matches the gun sprite's visual footprint at its widest point.
...
// pickup radius 20 = 38), so a stationary dropper never instantly re-collects the drop.
...
// the blocked weapon pickup they claim. Collect range is pr 18 + pickup 20 = 38 (where
