...
export const ARSENAL: Record<WeaponId, WeaponManifestEntry> = {
  ...
  scrapper: {
    role: "worn off-shoulder crossfire: rotate aim to place a fixed second lane",
    metrics: ["lane"],
    novelty: {
      nearest: "smg",
      axes: ["geometry", "positioning"],
      note: "The Hornet tracks one aim lane; Shoulderfire fires a straight ghost exactly 80° to one fixed side of current aim, so aim rotation places the second approach while movement never flips it.",
    },
    idealRange: "mid", target: "swarm",
    strength: "Deliberate aim rotation holds two straight approaches with one trigger.",
    weakness: "Pointing the main round straight at one tough body wastes the weaker shoulder lane.",
    resource: "none", status: "none",
    modifiers: "Pellet/spread mods affect the aimed volley; the single straight ghost stays at aim +80°.",
    audio: "shootRapid",
    visual: "#b6d36a aimed tracer plus a straight same-side off-shoulder ghost; held_scrapper",
    authority: ["bullets"],
    excelRoom: "swarm", weakRoom: "anchor",
  },
  skipper: {
