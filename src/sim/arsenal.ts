...
export const ARSENAL: Record<WeaponId, WeaponManifestEntry> = {
  ...
  scrapper: {
    ...
    novelty: {
      nearest: "smg",
      axes: ["geometry", "positioning"],
      note: "The Hornet tracks one aim lane; Shoulderfire splits aim from body orientation, so movement steers a fixed second lane while the main round stays on target.",
    },
    idealRange: "mid", target: "swarm",
    strength: "One trigger holds two independently steered lanes across a moving crowd.",
    weakness: "The shoulder lane is fixed to body facing and deals less damage, so poor movement wastes it.",
    resource: "none", status: "none",
    modifiers: "Pellet/spread mods affect the aimed volley; the single shoulder ghost stays fixed.",
    audio: "shootRapid",
    visual: "#b6d36a aimed tracer plus a body-steered acid-green ghost; held_scrapper",
    authority: ["bullets"],
    excelRoom: "swarm", weakRoom: "anchor",
  },
  skipper: {
