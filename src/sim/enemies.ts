...
import {
  ...
  jetHpForFloor, titheHpForFloor, quorumHpForFloor, gorgeHpForFloor, paleHpForFloor,
...
const BOSS_KINDS: readonly EnemyKind[] = ["boss", "marrow", "choir", "weaver", "gilded", "jet", "tithe", "quorum", "gorge", "pale"];
